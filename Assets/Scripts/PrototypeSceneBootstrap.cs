...
public static class PrototypeSceneBootstrap
{
    ...
    private static void CreateParallaxBackdrop(Camera camera)
    {
        ...
        CreateParallaxQuad("MidGlow", camera, farTexture, new Color(0.45f, 0.55f, 0.8f, 0.22f), new Vector3(0f, 0f, 24f), farLayerScale, new Vector2(0.5f, 0.5f), 0.0035f, 0f, 0.004f, 0f);
